                  ...
                  <Row className={styles.Rowrvs}>
                       ...
                       <Col xs={12} sm={12} md={6} className={styles.ClmPad}>
                            ...
                            <div className={styles.TopTxtdev}>
                               ...
                               <h4>অফারে হাদিয়া <span className={styles.span2}>১,৪৮০ টাকা</span></h4>
                            </div>  
                       ...
                       <Col xs={12} sm={12} md={6} className={styles.ClmPad}>
                                    ...
                                    <div className={styles.mainImglogo}><img src="images/landing_10/b.png" alt="img" />
                                        <div className={styles.Imgrelativ}>
                                                <div className={styles.ImgAbsolote}>
                                                        <span className={styles.persentxt}> 40% <br/> ছাড় </span>
                        ...
                        <div className={styles.topImg3}><img className={styles.topImg4} src="images/landing_10/b3.svg" alt="img" /></div>
